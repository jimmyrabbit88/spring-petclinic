pipeline {
    ...
    stages {
        ...
        stage("Deploy Container"){
            steps{
                sshagent(['aws-rem']){
                    sh "ssh -o StrictHostKeyChecking=no ec2-user@54.74.229.75 docker stop pet_clinic || true"
                    sh "ssh -o StrictHostKeyChecking=no ec2-user@54.74.229.75 docker rm pet_clinic || true"
